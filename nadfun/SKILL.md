...
| Module           | Purpose                                | Path                                  |
| ---------------- | -------------------------------------- | ------------------------------------- |
| **SKILL.md**     | Architecture, constants, setup         | [SKILL.md](./SKILL.md)                |
| **abi.md**       | Smart contract ABIs                    | [abi.md](./skills/abi.md)             |
| **quote.md**     | Price quotes, curve state              | [quote.md](./skills/quote.md)         |
| **trading.md**   | Buy, sell, permit signatures           | [trading.md](./skills/trading.md)     |
| **token.md**     | Balances, metadata, transfers          | [token.md](./skills/token.md)         |
| **create.md**    | Token creation, image upload           | [create.md](./skills/create.md)       |
| **indexer.md**   | Historical event querying              | [indexer.md](./skills/indexer.md)     |
| **agent-api.md** | REST API, API key management           | [agent-api.md](./skills/agent-api.md) |
| **wallet.md**    | Wallet generation                      | [wallet.md](./skills/wallet.md)       |
| **ausd.md**      | LiFi swap (MON → aUSD) + Upshift vault | [ausd.md](./skills/ausd.md)           |
...
Login is ONLY needed to manage API keys (create/list/delete). See [agent-api.md](./skills/agent-api.md) for:
